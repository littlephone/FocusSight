...
class connectionAttr{
	...
	/*		$timezonechk = $connect->query("SELECT * FROM usertz u, users s WHERE s.id= u.id AND s.username='".@$_SESSION['username']."'");
...
$attribute = new connectionAttr;
$pdotoolkit = new PDOToolkit;
/*
